...
;SW0 used as start/stop
;SW0 = 1 => Start
;SW0 = 0 => Stop 
JNB P2.0,stop; check if it is = 0, if 0, stop; else continue. 
...
CALL delay ;total delay 3/4 second
 ...
 CALL delay ;total delay 1 second
 MOV P1, #11111111B
 JB P2.0,cont; check if it is = 1, if 1, start; else continue. 
 SJMP stop; continue displaying the stopped time
cont: JMP start; restarting the stopwatch    
 RET      
...
loop: JNB TF0, loop ;looping till overflow of timer, upon overflow: reset
 CLR TR0
 CLR TF0
 RET
